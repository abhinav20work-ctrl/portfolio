...
export const projects = [
  ...
  },
  {
    ...
    tags: ["Global Content", "Opportunity", "Cultural reel"],
    analytics: { views: "9K", likes: "500", shares: "45" },
    shape: "wide",
  },
  {
    id: "project-15",
    ...
    description: "Contributed to the creative development and execution of the SYL-X1 Ground Test Reveal Campaign, showcasing Sarla Aviation's half-scale eVTOL demonstrator as it entered ground testing. The campaign highlighted a major engineering milestone through cinematic visuals and storytelling, communicating the transition from concept to validation while generating excitement around the future of urban air mobility.\n\nAssisted throughout the production process, including pre-production planning, creative direction, and on-ground shoot execution. Supported shot planning, coordinated with the production team during filming, and ensured the visuals aligned with the campaign's creative vision. In post-production, contributed to refining the edit, pacing, and overall storytelling to deliver a polished campaign film that effectively captured this milestone.",
    videoUrl:
    ...
    analytics: { views: "300K", likes: "15K", shares: "5K" },
    shape: "wide",
  },
  {
    id: "project-16",
  ...
  },
  {
    id: "project-18",
    categoryTag: "Brand Progress Video",
    title: "Inside the Hanger",
    description: "Created a cinematic brand film documenting the ongoing SYL-X1 ground test campaign at Sarla Aviation. The video captures the precision, discipline, and dedication behind aerospace testing, highlighting the engineering processes and the team's commitment to validating complex systems. Through immersive visuals and storytelling, the film showcases the quiet intensity that defines progress in aviation while reinforcing Sarla Aviation's mission of building India's future in advanced air mobility.",
    videoUrl:
    ...
    analytics: { views: "10K", likes: "756", shares: "46" },
    shape: "wide",
  },
  {
    id: "project-19",
